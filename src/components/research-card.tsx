...
export function ResearchCard({
  ...
  return (
    <Card
      className={cn(
        "flex flex-col overflow-hidden border border-border/50 hover:border-primary/30 transition-all duration-500 ease-in-out h-full bg-card/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl",
        className,
      )}
    >
      <CardHeader className="px-6 py-6 space-y-4 pb-2">
          ...
          {!isExpanded && (
             <div className="space-y-4">
               ...
               <Button 
                 ...
                 className="h-auto text-primary font-bold text-xs uppercase tracking-widest hover:no-underline flex items-center gap-1 group mt-8"
               >
                 Read more
      ...
      {isExpanded && (
        <CardContent className="px-6 pb-8 space-y-8 animate-in fade-in slide-in-from-top-2 duration-500">
